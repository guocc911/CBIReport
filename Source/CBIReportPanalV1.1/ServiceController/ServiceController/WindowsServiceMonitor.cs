...
namespace ServiceController
{
    ...
    public class WindowsServiceMonitor
    {
        ...
        public void Enable()
        {
            ...
            {
                throw new Exception("Could not enabke the service, error: " + e.Message);
            }
        }
        ...
        /// <summary>
        /// This will give us the displayname for the Windows Service that we have set in the constructor
        /// </summary>
        ...
        /// </summary>
        /// <param name="serviceName">The name of the service (don't use the display name!!)</param>
