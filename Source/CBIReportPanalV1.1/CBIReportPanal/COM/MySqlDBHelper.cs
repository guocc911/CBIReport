...
namespace COMM
{
    ...
    {
        // Fields
        public static string Conn = "Database='cbitrace';Data Source='localhost';User Id='root';Password='123456';charset='gb2312';pooling=true";
        ...
        public static bool ModifyConnectionInfo(string strConnect)
        {
